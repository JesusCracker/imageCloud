export default {
  ...
  'layout.user.link.company': '瀚维智能医疗ADC中心出品',
  ...
  'component.globalHeader.help': '帮助中心',
  ...
  'component.globalHeader.suggest': '产品建议',
  ...
  'menu.system.systemInformation': '系统消息',
  'menu.system.authList': '权限管理',
  'menu.system.roleList': '角色管理',
  'menu.system.zoneList': '区域管理',
  'menu.system.organList': '机构管理',
  'menu.reading': '阅片管理',
  'menu.reading.screenList': '筛查阅片',
  'menu.reading.scientificScreeningList': '科研阅片',
  'menu.approvalmanagement': '审批管理',
  'menu.dataAnalysis': '数据分析',
  'menu.dataAnalysis.loginLogList': '登录日志',
  'menu.accountInfo': '个人中心',
  'menu.helpCenter': '帮助中心',
  'menu.helpCenter.productSuggestionPage': '用户产品建议',
  'menu.reportmanagement': '报告管理',
  'menu.系统管理':'系统管理',
  'menu.系统管理.权限管理':'权限管理',
  'menu.阅片管理.筛查阅片':'筛查阅片',
  'menu.阅片管理.科研阅片':'科研阅片',
  ...
  'app.login.placeholderUserName': '请输入用户名',
  'app.login.placeholderPassword': '请输入密码',


  'app.login.message-invalid-credentials': '账户或密码错误（admin/ant.design）',
  'app.login.message-invalid-verification-code': '验证码错误',
  'app.login.tab-login-credentials': '账户密码登录',
  'app.login.tab-login-mobile': '验证码登陆',
  'app.login.placeholderPhone': '手机号',
  'app.login.placeholderCheckCode': '验证码',
