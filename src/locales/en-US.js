export default {
  ...
  'layout.user.link.company': 'Produced by Hanwei Smart Medical ADC Center',
  ...
  'component.globalHeader.suggest': 'Suggest',
  ...
  'menu.system.systemInformation': 'System Information',
  'menu.dataAnalysis': 'Data Analysis',
  'menu.dataAnalysis.loginLogList': 'Login Log',
  'menu.helpCenter': 'Help Center',
  'menu.helpCenter.productSuggestionPage': 'Product Suggestion',

  'app.login.placeholderUserName': 'please enter userName',
  'app.login.placeholderPassword': 'please enter passWords',
